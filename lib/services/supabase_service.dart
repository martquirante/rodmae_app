...
final class SupabaseWeddingRepository {
  ...
  Future<List<Transaction>> fetchFinances() async {
    try {
      if (AppRuntime.supabaseReady) {
  ...
  Stream<List<Transaction>> watchFinances() {
  ...
  Future<void> insertFinance(Transaction entry) async {
